...
4) Install all requirements(in Pycharm you can create a virtual environment and then open the _requirements.txt_ file which will automatically prompt a notification where you can simple click on 'install requirements'). Alternatively you can install all requirements by running:
```
