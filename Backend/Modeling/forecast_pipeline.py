...
def forecasting_pipeline(full_run=False, debug=False):
    ...
    for i, district in enumerate(districts):
        ...
        # add historical cases to the final_forecast_df
        ## final_forecast_df['date'], final_forecast_df['cases'] = y_train_sarima_df[Column.DATE].apply(lambda x: date_int_str(x)), \
        #                                                        y_train_sarima_df[Column.SEVEN_DAY_SMOOTHEN].apply()
